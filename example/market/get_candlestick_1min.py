...
def buy_or_sell(closeList, whenTime):
    ...
    if contr and nowshould:
        ...
        log.logger.info("buy Price:" + str(lastPrice) + "," + str(whenTime))
        contr = False
    ...
    if (bool(1 - contr)) and (bool(1 - nowshould)):
        if lastPrice == 0:
            ...
            if (now_price - lastPrice - now_price * 0.002 - lastPrice * 0.002) > 0:
                log.logger.info("sell Price:" + str(now_price) + "," + str(whenTime))
                ...
                log.logger.info("totalprofit:" + str(totalprofit) + "," + str(whenTime))
                contr = True
